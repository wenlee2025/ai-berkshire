...
This skill is generated from `skills/quality-screen.md` for Google Antigravity.
...
| 输入方式 | 示例 | 说明 |
|---------|------|------|
| 个股 | `英伟达, 苹果, 台积电, 联发科` | 逐家筛选 |
| 行业 | `全球云计算` `美股半导体` `台股伺服器代工` | 先搜索该行业主要上市公司（10-20家），再逐家筛选 |
| 市场/指数 | `纳斯达克100` `标普500` `台湾50成分股` | 拉取成分股列表，逐家筛选 |
| 主题 | `美股AI算力链` `台股高股息核心资产` | 先搜索主题相关公司，再逐家筛选 |
